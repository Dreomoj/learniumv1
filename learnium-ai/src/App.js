  ...
  return (
    <div>
       ...
       <div className='min-h-screen bg-black'>
        ...
        <div className='lg:flex justify-center gradient-text1 md:block text-center'>
            <p className='text font-black tracking-[-0.04em] text-6xl md:text-8xl'>Innovate.</p>
            <p className='text font-black tracking-[-0.04em] text-6xl md:text-8xl'>Educate.</p>
            <p className='text font-black tracking-[-0.04em] text-6xl md:text-8xl'>Thrive.</p>
